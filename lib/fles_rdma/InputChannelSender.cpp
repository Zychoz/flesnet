...
std::string InputChannelSender::report_status()
{
  ...
  ss << "written_desc=" << written_desc << ",";
  ss << "data_buffer_size=" << data_source_.data_buffer().size() << ",";
  ss << "cached_acked_data=" << cached_acked_data_ << ",";
  ss << "acked_data=" << acked_data_ << ",";
  ss << "sent_data=" << sent_data_ << ",";
  ss << "written_data=" << written_data << ",";
  ss << "delta_t=" << delta_t << ",";
